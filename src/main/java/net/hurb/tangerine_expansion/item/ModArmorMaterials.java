...
public enum ModArmorMaterials implements ArmorMaterial {
    TANGERINE_PEEL("tangerine_peel", 26, new int[]{2,7,5,2}, 10, SoundEvents.ARMOR_EQUIP_LEATHER,
            .75f, .25f, () -> Ingredient.of(ModItems.TANGERINE_PEEL.get()));
